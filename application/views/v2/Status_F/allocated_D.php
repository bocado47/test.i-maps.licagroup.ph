<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h1 class="h2">Allocated Dashboard</h1>
   ...
   var table=$('#table').DataTable({
                ...
                "columnDefs":[
                  ...
                  "drawCallback":function (settings){
                    ...
                    $(".changeAlloc").on('click',function(){
                      var id=$(this).val();
                      $.alert({
                           type:'blue',
                           columnClass:"col-sm-4 col-sm-offset-6",
                           title: 'Change Allocation Form',
                           content:'url:'+bUrl+'Dashboard/changeAlloc?id='+id,
                           buttons:{
                               save:{
                                   text:'Submit',
                                   btnClass: 'btn-green',
                                   action: function(){
                                       var main=this;
                                       var ar=$('#change_alloc_form').serialize();
                                       var action="Dashboard/change_alloc_function";
                                       if($('#change_alloc_form')[0].checkValidity() === false)
                                       {
                                           $('#change_alloc_form').addClass('was-validated');
                                       ...
                                       $.alert({
                                           ...
                                           content:function(){
                                               ...
                                               jQuery.notify({
                                                 // options
                                                 message: 'Change Allocation Successfuly!'
                                               },{
                                                 // settings
                                                  placement: {
                                                     from: "bottom",
