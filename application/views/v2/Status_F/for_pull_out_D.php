<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h1 class="h2">For Pull-Out Dashboard</h1>
...
$(document).ready(function() {
   ...
   var table=$('#table').DataTable({
                ...
                "sServerMethod": "GET",
                "bInfo": false,
                "sAjaxSource":bUrl+"Inventory/pulloutrecord",
                ...
                "drawCallback":function (settings){
                  ...
                  $(".report").on('click',function(){
                    ...
                    $.alert({
                         ...
                         columnClass:"col-sm-4 col-sm-offset-6",
                         title: 'Report Form',
                         content:'url:'+bUrl+'Dashboard/report_form?id='+id+'&po_num='+po_num,
                         buttons:{
                             save:{
                                 text:'Submit',
                                 btnClass: 'btn-green',
                                 action: function(){
                                     var main=this;
                                     var ar=$('#report_form').serialize();
                                     var action="Dashboard/report_function";
                                     if($('#report_form')[0].checkValidity() === false)
                                     {
                  ...
                  $(".allocate").on('click',function(){
                    ...
                    $.alert({
                         ...
                         columnClass:"col-sm-4 col-sm-offset-6",
                         title: 'Allocate Form',
                         content:'url:'+bUrl+'Dashboard/allocate?id='+id+'&po_num='+po_num,
                         buttons:{
                             save:{
                                 text:'Submit',
                                 btnClass: 'btn-green',
                                 action: function(){
                                     var main=this;
                                     var ar=$('#allocation_form').serialize();
                                     var action="Dashboard/allocate_function";
                                     if($('#allocation_form')[0].checkValidity() === false)
                                     {
                                         $('#allocation_form').addClass('was-validated');
