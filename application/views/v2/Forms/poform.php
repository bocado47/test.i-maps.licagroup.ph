...
if($type == 1)
{
	$dealer=$CI->Dsar_m->cmd($brand);
}else{
	$accessdealer=$CI->Admin_m->getaccess($ids);
	if(count($accessdealer) >= 1)
	{
		$dealer=$CI->Dsar_m->cmd3($accessdealer,$brand);
	}else{
		$dealer=$CI->Dsar_m->cmd($brand);
	}
				...
				<div class="form-group row">
					<div class="col-sm-6">
					    ...
					    <div class="col-sm-12">
					      ...
					      <input type="hidden"  class="form-control" name="rt_id" id="rt_id" value="<?php echo $rt_id; ?>" required/>
			  	...
			  	<div class="form-group row">
					...
					<div class="form-group row">
						<div class="col-sm-6">
							...
							<div class="col-sm-12">
								<input type="hidden" class="form-control"  name="model" id="model" value="<?php echo $model; ?>" readonly/>
								<input type="text" class="form-control"  name="product" id="product" value="<?php echo $product; ?>" readonly/>
							</div>
						</div>
						<div class="col-sm-6">
					...
					<div class="form-group row">
						...
						<div class="col-sm-6">
							...
							<div class="col-sm-12">
								<input type="text"  class="form-control money"  name="cost" id="cost" value="<?php echo number_format((float)$cost,2,'.',''); ?>" required/>
								<div class="invalid-feedback">
